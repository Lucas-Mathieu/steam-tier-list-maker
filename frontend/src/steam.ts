...
export const steamArtworkUrl=(appid:number)=>`https://cdn.akamai.steamstatic.com/steam/apps/${appid}/library_600x900.jpg`;
export const steamHeaderUrl=(appid:number)=>`https://cdn.akamai.steamstatic.com/steam/apps/${appid}/header.jpg`;
